<template>
  <div class="p-4">
    ...
    <div v-else class="space-y-4">
      ...
      >
        <div class="flex items-center justify-between p-4">
          <div class="flex items-center space-x-4">
            ...
            <div>
              <h4 class="font-semibold text-gray-800">Dr. {{ doctor.name }}</h4>
      ...
      <!-- Doctors count -->
      <div v-if="data && data.total > 0" class="text-center text-sm text-gray-600 pt-4">
        {{ data.data.length }} doctor(es) encontrado(s)
      </div>
    </div>
  </div>
</template>
